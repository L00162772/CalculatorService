...
pipeline {
    ...
    stages {
        ...
        stage('Build Docker Image') {
            steps {
                withCredentials([string(credentialsId: 'AWS_Personal', variable: 'AWS_ECR_URL')]) {
                    script {
        ...
        stage('Deploy in ECS') {
            steps {
                withCredentials([string(credentialsId: 'AWS_EXECUTION_ROL_SECRET', variable: 'AWS_ECS_EXECUTION_ROL'),string(credentialsId: 'AWS_Personal', variable: 'AWS_ECR_URL')]) {
                    script {
